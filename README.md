...
The **Calculate Pi Scripts** is a **GitHub repository** that holds many **code files**, **executables** (that includes **bytecode**), that calculate the **Pi**. The majority of the languages present here, are good at calculating, because I've searched much and selected the **best languages** with the **best performance** in this matter (and others that aren't used very much for math, but they're **known**, and **I like it**, but if you think it should be **deleted** because it's ***nonsense*** using it, **I'll delete it**), and also the **best methods** to **calculate** (like **Chudnovsky**, **Monte Carlo**, **Leibniz**, **Nilakantha**, or simply **Math.PI**).

## How to download?
Go to the **Releases**, and download the files you want, based on your OS, because the **.EXEs** only work on **Windows™**, and the **not ending in .exe executables** on **Unix-like** systems. **Please follow the instructions showed in the Releases, for not get doubts and problems with dependencies and such things.**
## How to contribute?
...
## Copyright Doubt and Ownership of the files
